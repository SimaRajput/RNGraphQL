...
var ViewPropTypes = _reactNative.ViewPropTypes || _reactNative.View.propTypes; var
  ...
  Toast = function (_Component) {
    _inherits(Toast, _Component); function Toast() {
      var _ref; var _temp, _this, _ret; _classCallCheck(this, Toast); for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) { args[_key] = arguments[_key]; } return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Toast.__proto__ || Object.getPrototypeOf(Toast)).call.apply(_ref, [this].concat(args))), _this), _this.
        state = {
      ...
      key: 'UNSAFE_componentWillReceiveProps', value: function UNSAFE_componentWillReceiveProps(_ref2) {
      ...
      key: 'show', value: function show(
        ...
        message, _ref3) {
          var _this3 = this; var error = _ref3.error, warning = _ref3.warning, dismissTimeout = _ref3.dismissTimeout;
        this.setState(
          {
            present: true,
            fadeAnimation: new _reactNative.Animated.Value(0),
  ...
  }(_react.Component); exports.default = Toast;
