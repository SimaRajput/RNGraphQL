...
import {
  updateTodoList, deleteTodoList, queryAllTodoLists,
...
let FlatListItem = ({ itemIndex, item: { id, name, creationDate }, popupDialogComponent, onPressItem }) => {

  console.log("id", id, " name", name, "creation date", creationDate);
  showEditModal = () => {
...
export default class TodoListComponent extends Component {
  ...
  render() {
    console.log("list data", this.state.todoLists);
